	...
	*/
		...
		where TPoint : IGridPoint<TPoint>
	{
		...
		*/
		...
		/**
			Animates a according to a fixed funciton. This is useful for animating grids
			...
			@param This inverse funciton returns the point in the static grid, given the 
