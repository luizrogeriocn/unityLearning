...
namespace Gamelogic.Grids
{
	/**
		...
		Note also that the transformations only apply to the world points returned and procssed by the map, 
	...
	*/
		...
		where TPoint : IGridPoint<TPoint>
	{
		...
		*/
		...
		/** 
			@name Helper Methods for Implementors.
		*/
		/**@{*/
		...
		*/
		...
		/**
			Returns an IMap where grid cells are scaled about the origin by 90 degrees.
		*/
