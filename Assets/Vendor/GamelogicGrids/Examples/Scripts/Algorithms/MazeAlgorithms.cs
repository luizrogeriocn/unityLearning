...
public static partial class MazeAlgorithms
{
	...
	*/
	...
	/**
		...
		@returns a IEnumerable of passages 
	*/
	public static IEnumerable<PointyRhombPoint> GenerateMazeWalls(FlatTriGrid<Cell> grid)
	{
		var walls = grid.MakeEdgeGrid<bool>(); //true indicates passable
		var wallList = new PointList<PointyRhombPoint>();

		var newMaizePoint = grid.RandomItem<FlatTriPoint>();
	...
	/**
		...
		@returns a IEnumerable of passages 
	*/
	public static IGrid<bool, PointyRhombPoint> GenerateMaze(FlatTriGrid<Cell> grid)
	{
		var walls = grid.MakeEdgeGrid<bool>(); //true indicates passable
		var wallList = new PointList<PointyRhombPoint>();
